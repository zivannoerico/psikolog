...
@section('title', 'Dokumentasi Video — An Moerty Psikologi Banyuwangi')
@section('description', 'Kumpulan video kegiatan, program, dan tayangan An Moerty Psikologi Banyuwangi.')
@section('og_title', 'Dokumentasi Video — An Moerty Psikologi Banyuwangi')
    ...
    <div class="dok-video-grid reveal">
      ...
      <div class="dok-video-card">
        ...
        <div class="dok-video-info">
          ...
          @if($video->deskripsi)
          <p class="dok-video-desc">{{ $video->deskripsi }}</p>
          @endif
        </div>
      </div>
      @endforeach
