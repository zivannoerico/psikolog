    ...
    <div id="sidebar" class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-72 lg:sidebar-expanded:!w-72 2xl:!w-72 shrink-0 bg-white border-r border-slate-100 transition-all duration-300 ease-in-out shadow-sm lg:shadow-none"
        ...
        <div class="space-y-8 px-4 py-8">
            <ul class="space-y-1">
                <!-- Dashboard -->
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600' }} group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 {{ request()->routeIs('dashboard') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Layanan -->
                <li>
                    <a href="{{ route('admin.layanan.index') }}" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.layanan.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600' }} group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 {{ request()->routeIs('admin.layanan.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Artikel -->
                <li>
                    <a href="{{ route('admin.artikel.index') }}" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.artikel.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600' }} group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 {{ request()->routeIs('admin.artikel.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Testimoni -->
                <li>
                    <a href="{{ route('admin.testimoni.index') }}" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.testimoni.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600' }} group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 {{ request()->routeIs('admin.testimoni.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-slate-100 pt-6">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 hover:bg-slate-50 hover:text-indigo-600 group">
