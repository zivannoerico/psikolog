...
<section class="service-hero">
    <div class="container">
        <h1>Konseling Kerja Karyawan</h1>
        <p>Konseling untuk membantu karyawan menemukan kembali motivasi dan produktivitas di tempat kerja.</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="service-grid">
            <div class="service-img-wrapper">
                <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&q=80&w=800" alt="Konseling Kerja Karyawan" class="service-img">
            </div>
            <div class="service-text">
                ...
                <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179'))) }}?text=Halo%20An%20Moerty%20Psikologi,%20saya%20tertarik%20dengan%20Konseling Kerja Karyawan" target="_blank" class="btn btn-primary" style="margin-top: 30px; border-radius: 30px;">
