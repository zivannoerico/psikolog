@extends('layouts.app')
@section('title', 'Layanan Interview - An Moerty Psikologi')
...
<section class="service-hero">
    <div class="container">
        <h1>Layanan Interview</h1>
        <p>Wawancara psikologis mendalam untuk menggali kompetensi, motivasi, dan kesesuaian.</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="service-grid">
            <div class="service-img-wrapper">
                <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&q=80&w=800" alt="Layanan Interview" class="service-img">
            </div>
