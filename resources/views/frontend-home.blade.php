    ...
    <div class="hero-inner">
      ...
      <div class="hero-visual" aria-hidden="true">
        <div class="hero-ref-composition">
          ...
          {{-- SPARKLE ACCENT: Upper Right --}}
          <span class="hero-ref-sparkle sparkle-top-right">✦</span>

          {{-- MAIN BACKDROP & PORTRAIT CUTOUT --}}
