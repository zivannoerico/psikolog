                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div class="md:col-span-2 space-y-8">
                        <div>
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul', $video->judul) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Contoh: Kegiatan Psikotes PT Sukses Makmur 2024">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Deskripsi singkat tentang video...">{{ old('deskripsi', $video->deskripsi) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="url" name="video_url" id="video_url" value="{{ old('video_url', $video->video_url) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="https://www.youtube.com/watch?v=...">
                        ...
                        <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $video->urutan) }}" min="0" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="aktif" id="aktif" value="1" {{ old('aktif', $video->aktif) ? 'checked' : '' }} class="sr-only peer">
