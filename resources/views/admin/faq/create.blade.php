<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.faq.store') }}" method="POST" class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            @csrf
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="pertanyaan" id="pertanyaan" value="{{ old('pertanyaan') }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Masukkan pertanyaan...">
                    @error('pertanyaan')
                ...
                <div>
                    ...
                    <textarea name="jawaban" id="jawaban" rows="5" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Masukkan jawaban...">{{ old('jawaban') }}</textarea>
                    @error('jawaban')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan" value="{{ old('urutan', 0) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Contoh: 1">
                    ...
                    <div x-data="{ aktif: {{ old('aktif', 1) ? 'true' : 'false' }} }">
