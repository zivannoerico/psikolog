                    ...
                    <div class="md:col-span-2 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $testimoni->nama) }}" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $testimoni->jabatan) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" name="institusi" id="institusi" value="{{ old('institusi', $testimoni->institusi) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
                        ...
                        <div>
                            ...
                            <textarea name="isi" id="isi" rows="5" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">{{ old('isi', $testimoni->isi) }}</textarea>
                        ...
                        <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <div class="h-20 w-20 rounded-full border border-slate-200 p-1 bg-white overflow-hidden shadow-sm mx-auto">
                                            <img src="{{ asset('storage/' . $testimoni->foto) }}" alt="Foto" class="h-full w-full object-cover rounded-full">
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $testimoni->urutan) }}" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all bg-white">
                                ...
                                <div>
                                    ...
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="aktif" value="1" {{ old('aktif', $testimoni->aktif) ? 'checked' : '' }} class="sr-only peer">
