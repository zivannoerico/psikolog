    ...
    <div class="container--narrow">
      ...
      <div style="margin-top:var(--space-8); padding:var(--space-6) var(--space-8); background:var(--clr-bg-alt); border-radius:var(--radius-md); border:1px solid var(--clr-border);">
        ...
        <div style="display:flex; gap:var(--space-3); flex-wrap:wrap;">
          <a href="https://wa.me/?text={{ urlencode($artikel->judul . ' - ' . url()->current()) }}" class="btn btn--outline btn--sm" target="_blank" rel="noopener" aria-label="Share via WhatsApp">
          ...
          <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" class="btn btn--outline btn--sm" target="_blank" rel="noopener" aria-label="Share via Facebook">Facebook</a>
          <a href="https://twitter.com/intent/tweet?text={{ urlencode($artikel->judul) }}&url={{ urlencode(url()->current()) }}" class="btn btn--outline btn--sm" target="_blank" rel="noopener" aria-label="Share via Twitter">Twitter</a>
        </div>
      </div>
    </div>
  </section>
