        ...
        <address style="font-style:normal;">
          <div class="contact-info-item">
            ...
            <div>
              ...
              <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179'))) }}" class="contact-info-value" style="font-weight:600; color:var(--clr-primary); text-decoration:none;" target="_blank" rel="noopener noreferrer">0822-3339-2179</a>
            </div>
          </div>
