    ...
    <div class="contact-layout">
      ...
      <div class="reveal reveal-delay-2">
        ...
        <address style="font-style:normal;">
          <div class="contact-info-item">
            ...
            <div>
              ...
              <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179'))) }}" class="contact-info-value" target="_blank" rel="noopener">0822-3339-2179</a>
            </div>
          </div>
        ...
        <div style="margin-top:var(--space-6); padding:var(--space-5) var(--space-6); background:linear-gradient(135deg, #25D366 0%, #1eb358 100%); border-radius:var(--radius-md);">
          ...
          <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179'))) }}?text={{ urlencode('Halo An Moerty Psikologi, saya ingin konsultasi. Apakah bisa bantu saya?') }}" class="btn" style="background:white; color:#1eb358; font-weight:700;" target="_blank" rel="noopener">
