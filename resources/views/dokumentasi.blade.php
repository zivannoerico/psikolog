...
@section('description', 'Lihat berbagai dokumentasi kegiatan, program, dan momen bersama An Moerty Psikologi Banyuwangi.')
    ...
    <div class="dok-video-grid reveal">
      ...
      <div class="dok-video-card">
        ...
        <div class="dok-video-info">
          ...
          @if($video->deskripsi)
          <p class="dok-video-desc">{{ Str::limit($video->deskripsi, 100) }}</p>
          @endif
        </div>
      </div>
      @endforeach
