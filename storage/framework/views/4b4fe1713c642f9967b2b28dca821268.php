    ...
    <div id="sidebar" class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-72 lg:sidebar-expanded:!w-72 2xl:!w-72 shrink-0 bg-white border-r border-slate-100 transition-all duration-300 ease-in-out shadow-sm lg:shadow-none"
        ...
        <div class="flex justify-between items-center pr-3 sm:px-6 py-6 border-b border-slate-100">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center w-full">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo An Moerty" class="h-12 w-auto object-contain" style="filter: brightness(0) saturate(100%) invert(43%) sepia(35%) saturate(1015%) hue-rotate(297deg) brightness(85%) contrast(89%);">
            </a>
        ...
        <div class="space-y-8 px-4 py-8">
            <ul class="space-y-1">
                ...
                <!-- FAQ -->
                <li>
                    <a href="<?php echo e(route('admin.faq.index')); ?>" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.faq.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600'); ?> group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 <?php echo e(request()->routeIs('admin.faq.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500'); ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="flex-1 ml-4 whitespace-nowrap">FAQ</span>
                    </a>
                </li>

                <!-- Dokumentasi Foto -->
                <li>
                    <a href="<?php echo e(route('admin.galeri.index')); ?>" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.galeri.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600'); ?> group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 <?php echo e(request()->routeIs('admin.galeri.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500'); ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="flex-1 ml-4 whitespace-nowrap">Dokumentasi Foto</span>
                    </a>
                </li>

                <!-- Dokumentasi Video -->
                <li>
                    <a href="<?php echo e(route('admin.dokumentasi-video.index')); ?>" class="flex items-center px-4 py-3 text-slate-600 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.dokumentasi-video.*') ? 'bg-indigo-50/80 text-indigo-600 font-semibold shadow-sm' : 'hover:bg-slate-50 hover:text-indigo-600'); ?> group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-200 <?php echo e(request()->routeIs('admin.dokumentasi-video.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-500'); ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="flex-1 ml-4 whitespace-nowrap">Dokumentasi Video</span>
                    </a>
                </li>
            </ul>
...
<?php /**PATH D:\project pkl\psikolog\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>