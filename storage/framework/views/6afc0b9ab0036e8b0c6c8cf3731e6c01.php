  ...
  <div class="container" style="max-width:860px;">
    ...
    <div class="reveal" style="margin-top:var(--space-16); background:var(--clr-bg-alt); border-radius:var(--radius-lg); padding:var(--space-10); text-align:center; border:1px solid var(--clr-border);">
      ...
      <div style="display:flex; gap:var(--space-4); justify-content:center; flex-wrap:wrap;">
        <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179')))); ?>" class="btn btn--primary" target="_blank" rel="noopener noreferrer">Chat WhatsApp</a>
