  ...
  <nav id="navbar" role="navigation" aria-label="Navigasi Utama">
    <div class="container navbar-inner">
      ...
      <ul class="navbar-nav" role="list">
        ...
        <li class="nav-item">
          <a href="<?php echo e(route('dokumentasi.index')); ?>" class="nav-link <?php echo e(request()->routeIs('dokumentasi.*') ? 'active' : ''); ?>" aria-haspopup="true" aria-expanded="false">
            Dokumentasi
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>
          </a>
          <div class="dropdown" role="menu" aria-label="Sub-menu Dokumentasi">
            <a href="<?php echo e(route('dokumentasi.foto')); ?>" class="dropdown-link" role="menuitem">
            ...
            <a href="<?php echo e(route('dokumentasi.video')); ?>" class="dropdown-link" role="menuitem">
  ...
  <div class="mobile-menu" id="mobileMenu" role="dialog" aria-label="Menu Navigasi Mobile" aria-modal="true">
    ...
    <div>
      ...
      <div class="mobile-submenu" id="mobileDokumentasiSub">
        <a href="<?php echo e(route('dokumentasi.index')); ?>" class="mobile-submenu-link">Ringkasan Dokumentasi</a>
        <a href="<?php echo e(route('dokumentasi.foto')); ?>" class="mobile-submenu-link">Dokumentasi Foto</a>
        <a href="<?php echo e(route('dokumentasi.video')); ?>" class="mobile-submenu-link">Dokumentasi Video</a>
      </div>
    </div>
...
<?php endif; ?>
        ...
        <div>
          ...
          <ul class="footer-links" role="list">
            ...
            <li><a href="<?php echo e(route('dokumentasi.index')); ?>" class="footer-link">Dokumentasi</a></li>
...
<?php /**PATH D:\project pkl\psikolog\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>