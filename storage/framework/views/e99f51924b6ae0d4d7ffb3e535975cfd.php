...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-slate-800 tracking-tight">
                    <?php echo e(__('Edit Video Dokumentasi')); ?>

                </h2>
                <p class="text-sm text-slate-500 mt-1">Ubah data video dokumentasi kegiatan.</p>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 sm:p-10">
            <form action="<?php echo e(route('admin.dokumentasi-video.update', $video)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div class="md:col-span-2 space-y-8">
                        <div>
                            ...
                            <input type="text" name="judul" id="judul" value="<?php echo e(old('judul', $video->judul)); ?>" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Contoh: Kegiatan Psikotes PT Sukses Makmur 2024">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Deskripsi singkat tentang video..."><?php echo e(old('deskripsi', $video->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="video_url" id="video_url" value="<?php echo e(old('video_url', $video->video_url)); ?>" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="https://www.youtube.com/watch?v=...">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="w-48 h-28 rounded-xl overflow-hidden border border-slate-200 bg-slate-50 relative">
                                <img src="<?php echo e($video->thumbnail_url); ?>" alt="<?php echo e($video->judul); ?>" class="w-full h-full object-cover">
                    ...
                    <div class="space-y-8">
                        <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label for="thumbnail" class="block text-sm font-bold text-slate-700 mb-2">Ganti Thumbnail <span class="text-slate-400 font-normal">(Opsional)</span></label>
                                    ...
                                    <p class="text-xs text-slate-400 mt-2">Kosongkan jika tidak ingin mengganti thumbnail.</p>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="urutan" id="urutan" value="<?php echo e(old('urutan', $video->urutan)); ?>" min="0" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="aktif" id="aktif" value="1" <?php echo e(old('aktif', $video->aktif) ? 'checked' : ''); ?> class="sr-only peer">
...
<?php endif; ?>
<?php /**PATH D:\project pkl\psikolog\resources\views/admin/dokumentasi-video/edit.blade.php ENDPATH**/ ?>