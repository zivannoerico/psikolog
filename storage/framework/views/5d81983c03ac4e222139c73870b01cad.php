...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-slate-800 tracking-tight">
                    <?php echo e(__('Edit Testimoni')); ?>

                </h2>
                <p class="text-sm text-slate-500 mt-1">Lakukan perubahan pada ulasan klien ini.</p>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 sm:p-10">
            <form action="<?php echo e(route('admin.testimoni.update', $testimoni)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="md:col-span-2 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="<?php echo e(old('nama', $testimoni->nama)); ?>" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="jabatan" id="jabatan" value="<?php echo e(old('jabatan', $testimoni->jabatan)); ?>" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="institusi" id="institusi" value="<?php echo e(old('institusi', $testimoni->institusi)); ?>" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="isi" id="isi" rows="5" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all"><?php echo e(old('isi', $testimoni->isi)); ?></textarea>
                            <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select name="rating" id="rating" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all bg-white font-medium text-amber-500">
                                        <option value="5" <?php echo e(old('rating', $testimoni->rating) == '5' ? 'selected' : ''); ?>>⭐⭐⭐⭐⭐ (5/5)</option>
                                        <option value="4" <?php echo e(old('rating', $testimoni->rating) == '4' ? 'selected' : ''); ?>>⭐⭐⭐⭐ (4/5)</option>
                                        <option value="3" <?php echo e(old('rating', $testimoni->rating) == '3' ? 'selected' : ''); ?>>⭐⭐⭐ (3/5)</option>
                                        <option value="2" <?php echo e(old('rating', $testimoni->rating) == '2' ? 'selected' : ''); ?>>⭐⭐ (2/5)</option>
                                        <option value="1" <?php echo e(old('rating', $testimoni->rating) == '1' ? 'selected' : ''); ?>>⭐ (1/5)</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <div class="h-20 w-20 rounded-full border border-slate-200 p-1 bg-white overflow-hidden shadow-sm mx-auto">
                                            <img src="<?php echo e(asset('storage/' . $testimoni->foto)); ?>" alt="Foto" class="h-full w-full object-cover rounded-full">
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <p class="text-xs text-slate-500 mt-2 text-center">Abaikan jika tidak ingin mengubah foto.</p>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="urutan" id="urutan" value="<?php echo e(old('urutan', $testimoni->urutan)); ?>" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all bg-white">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="aktif" value="1" <?php echo e(old('aktif', $testimoni->aktif) ? 'checked' : ''); ?> class="sr-only peer">
...
<?php endif; ?>
<?php /**PATH D:\psikolog\resources\views/admin/testimoni/edit.blade.php ENDPATH**/ ?>