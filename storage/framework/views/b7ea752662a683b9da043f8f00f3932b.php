    ...
    <div class="layanan-detail-grid">
      ...
      <aside class="layanan-sidebar" aria-label="Navigasi layanan">
        ...
        <div class="sidebar-card" style="margin-bottom:var(--space-6); background:var(--clr-text); border-color:transparent;">
          ...
          <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179')))); ?>?text=<?php echo e(urlencode('Halo, saya tertarik dengan layanan ' . $layanan->nama . '. Boleh konsultasi lebih lanjut?')); ?>" class="btn btn--white btn--full" target="_blank" rel="noopener">
