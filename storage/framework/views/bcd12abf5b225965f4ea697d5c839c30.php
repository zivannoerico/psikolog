...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($limitedState)): ?>
        <div class="flex items-center gap-x-2.5">
            ...
            >
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasLimitedRemainingText && ($loop->iteration < count($limitedState)) && (! $isLimitedRemainingTextSeparate) && $isCircular): ?>
                    <div
                        style="
...
<?php /**PATH D:\psikolog\vendor\filament\tables\resources\views/columns/image-column.blade.php ENDPATH**/ ?>