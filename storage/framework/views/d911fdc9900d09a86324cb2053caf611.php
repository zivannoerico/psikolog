...
<section class="section section--alt" id="layanan" aria-labelledby="layanan-heading">
  <div class="container">
    ...
    <div class="grid-auto-3">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <article class="service-card reveal reveal-delay-<?php echo e(($i % 3) + 1); ?>" aria-labelledby="layanan-<?php echo e($item->id); ?>">
          <div class="service-icon-wrap" aria-hidden="true">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($item->ikon):
              case ('clipboard-list'): ?>
          ...
          <div>
            <span class="card-badge"><?php echo e($item->kategori->nama ?? ''); ?></span>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimoni->count()): ?>
<section class="section section--alt" id="testimoni" aria-labelledby="testi-heading">
  <div class="container">
    ...
    <div class="grid-auto-3">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $testimoni->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="testi-card reveal reveal-delay-<?php echo e($i + 1); ?>">
          <div class="testi-stars" aria-label="<?php echo e($testi->rating); ?> dari 5 bintang">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($s = 1; $s <= 5; $s++): ?>
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s <= $testi->rating): ?>
          ...
          <div class="testi-author">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testi->foto): ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div>
              <div class="testi-name"><?php echo e($testi->nama); ?></div>
              <div class="testi-role"><?php echo e($testi->jabatan); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testi->institusi): ?> — <?php echo e($testi->institusi); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
            </div>
          </div>
        </article>
    ...
    <div class="text-center mt-8 reveal">
      <a href="<?php echo e(route('testimoni.index')); ?>" class="btn btn--ghost">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($faq->count()): ?>
<section class="section" id="faq" aria-labelledby="faq-heading">
  <div class="container" style="max-width: 800px;">
    ...
    <div style="display:flex; flex-direction:column; gap:var(--space-3);" role="list">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="faq-item reveal reveal-delay-<?php echo e(($i % 3) + 1); ?>" role="listitem">
          <button class="faq-question" aria-expanded="false" aria-controls="faq-ans-<?php echo e($item->id); ?>">
          ...
          <div class="faq-answer" id="faq-ans-<?php echo e($item->id); ?>" role="region">
            <div class="faq-answer-inner"><?php echo e($item->jawaban); ?></div>
          </div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <div class="text-center mt-8 reveal">
      <a href="<?php echo e(route('faq.index')); ?>" class="btn btn--ghost">
        Lihat Semua FAQ
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg>
      </a>
    </div>
  ...
  <div class="container">
    ...
    <div class="grid-3">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $artikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="card reveal reveal-delay-<?php echo e($i + 1); ?>" aria-labelledby="art-<?php echo e($art->id); ?>">
          ...
          <div class="card-body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($art->kategori): ?>
              <span class="card-badge"><?php echo e($art->kategori->nama); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="card-meta">
              <span><?php echo e($art->published_at?->translatedFormat('d M Y')); ?></span>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($art->penulis): ?>
                <span>· <?php echo e($art->penulis); ?></span>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
          </div>
        </article>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\psikolog\resources\views/welcome.blade.php ENDPATH**/ ?>