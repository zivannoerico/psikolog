        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-slate-800 tracking-tight">
                    <?php echo e(__('Tambah Layanan Baru')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div class="md:col-span-2 space-y-8">
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" value="<?php echo e(old('nama')); ?>" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Contoh: Konseling Individu">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi_singkat" id="deskripsi_singkat" rows="3" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Tuliskan deskripsi singkat mengenai layanan ini..."><?php echo e(old('deskripsi_singkat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="prose max-w-none">
                                <input id="deskripsi_lengkap" type="hidden" name="deskripsi_lengkap" value="<?php echo e(old('deskripsi_lengkap')); ?>">
                                ...
                                <div>
                                    ...
                                    <select name="kategori_layanan_id" id="kategori_layanan_id" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all bg-white">
                                        ...
                                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($kategori->id); ?>" <?php echo e(old('kategori_layanan_id') == $kategori->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ikon" id="ikon" value="<?php echo e(old('ikon')); ?>" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm text-sm p-3 transition-all" placeholder="Contoh: clipboard-check">
...
<?php endif; ?>
<?php /**PATH D:\psikolog\resources\views/admin/layanan/create.blade.php ENDPATH**/ ?>