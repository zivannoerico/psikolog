...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="<?php echo e(route('admin.faq.update', $faq)); ?>" method="POST" class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="pertanyaan" id="pertanyaan" value="<?php echo e(old('pertanyaan', $faq->pertanyaan)); ?>" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Masukkan pertanyaan...">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="jawaban" id="jawaban" rows="5" required class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Masukkan jawaban..."><?php echo e(old('jawaban', $faq->jawaban)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan" value="<?php echo e(old('urutan', $faq->urutan)); ?>" class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="Contoh: 1">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-data="{ aktif: <?php echo e(old('aktif', $faq->aktif) ? 'true' : 'false'); ?> }">
...
<?php endif; ?>
<?php /**PATH D:\psikolog\resources\views/admin/faq/edit.blade.php ENDPATH**/ ?>