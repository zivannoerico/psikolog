  ...
  <div class="container">
    ...
    <div class="testi-slider-container reveal">
      <div class="testi-slider-track">
        ...
        <?php $__currentLoopData = array_merge($testimoni->all(), $testimoni->all()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="testi-card testi-card-slide h-full">
            ...
            <blockquote>
              <p class="testi-text mb-4">"<?php echo e($testi->isi); ?>"</p>
            </blockquote>
      ...
      <?php $__currentLoopData = $artikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="card reveal reveal-delay-<?php echo e($i + 1); ?>" aria-labelledby="art-<?php echo e($art->id); ?>">
          ...
          <div class="card-body" style="padding: var(--space-5);">
            <h3 class="card-title" id="art-<?php echo e($art->id); ?>" style="margin-bottom: var(--space-4); font-size: 1.125rem; line-height: 1.5;">
            ...
            <div style="font-size: 0.8125rem; color: var(--clr-text-3); margin-bottom: var(--space-4);">
              <div style="margin-bottom: var(--space-3);"><?php echo e($art->published_at?->translatedFormat('d M Y')); ?></div>
              <?php if($art->penulis): ?>
    ...
    <div class="cta-section reveal">
      <div class="cta-content">
        ...
        <div class="cta-actions">
          <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', \App\Models\Setting::get('kontak_telpon', '082233392179')))); ?>?text=<?php echo e(urlencode(\App\Models\Setting::get('wa_pesan_default', 'Halo An Moerty Psikologi, saya ingin konsultasi gratis. Bisakah kita berbicara?'))); ?>" class="btn btn--white btn--lg" target="_blank" rel="noopener noreferrer">
