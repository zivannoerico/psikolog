...
<section class="section section--alt" id="testimoni" aria-labelledby="testi-heading">
  <div class="container">
    ...
    <div class="grid-auto-3">
      <?php $__currentLoopData = $testimoni->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
